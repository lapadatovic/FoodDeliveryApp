...
export default function MainContainer() {
  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center'>
        ...
        <section className='w-full my-5'>
          <div className='w-full flex items-center justify-between'>
            ...
            <div className='hidden md:flex gap-3 items-center '>
              <motion.div whileTap={{scale: 0.75}} className='w-8 h-8 rounded-lg bg-orange-300 flex cursor-pointer hover:bg-orange-500 items-center justify-center transition-all duration-100 ease-in-out hover:shadow-lg'>
        ...
        <RowContainer flag={true} data={foodItems?.filter(food => food.category === 'fruits')}/>
        </section>
    </div>
  )
}
